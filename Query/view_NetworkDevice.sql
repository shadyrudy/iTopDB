...
SELECT DISTINCT NetworkDevice.id                                                                                         AS id,
...
WHERE ((
    ...
    AND (
           0 <>
           COALESCE((PowerConnection_powerA_id_PhysicalDevice.finalclass IN ('PowerSource', 'PDU', 'PowerConnection')),
                    1))
    AND (
           0 <>
           COALESCE((PowerConnection_powerB_id_PhysicalDevice.finalclass IN ('PowerSource', 'PDU', 'PowerConnection')),
                    1))
    AND (
