-- View Database Schmea
SELECT DISTINCT DatabaseSchema.id                                                                     AS id,
                ...
                COALESCE((DBServer_dbserver_id_SoftwareInstance.status = 'inactive'),
                         0)                                                                           AS dbserver_id_obsolescence_flag
FROM ((
