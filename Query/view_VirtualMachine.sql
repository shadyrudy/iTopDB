...
SELECT DISTINCT VirtualMachine.id                                                                                AS id,
                ...
                COALESCE((VirtualHost_virtualhost_id_VirtualDevice.status = 'obsolete'),
                         0)                                                                                      AS virtualhost_id_obsolescence_flag,
                ...
                COALESCE(((
                    ...
                    AND (
                              OSLicence_oslicence_id_Licence.end_date <
...
WHERE ((
           0 <>
           COALESCE((VirtualHost_virtualhost_id_VirtualDevice.finalclass IN ('Hypervisor', 'Farm', 'VirtualHost')), 1))
    AND (
