-- View Connectable CI
SELECT DISTINCT ConnectableCI_PhysicalDevice.id                                                     AS id,
...
WHERE ((
    ...
    AND (
               0 <> COALESCE((ConnectableCI_PhysicalDevice.finalclass IN
                              ('DatacenterDevice', 'NetworkDevice', 'Server', 'PC', 'Printer', 'StorageSystem',
                               'SANSwitch', 'TapeLibrary', 'NAS', 'ConnectableCI')), 1)))