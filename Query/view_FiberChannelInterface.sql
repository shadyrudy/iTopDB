-- View FiberChannelInterface information
SELECT DISTINCT FiberChannelInterface.id                                                                                   AS id,
                ...
                COALESCE(COALESCE((DatacenterDevice_datacenterdevice_id_PhysicalDevice.status = 'obsolete'), 0),
                ...
                COALESCE((DatacenterDevice_datacenterdevice_id_PhysicalDevice.status = 'obsolete'),
                         0)                                                                                                AS datacenterdevice_id_obsolescence_flag
FROM ((
