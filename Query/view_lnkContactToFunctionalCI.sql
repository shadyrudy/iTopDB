-- View Link Contact to Functional CI
SELECT DISTINCT lnkContactToFunctionalCI.id                                                                         AS id,
                ...
                IF
                ((
                     FunctionalCI_functionalci_id.finalclass IN
                     ...
                     ((
                      ...
                      ((
                       ...
                       ((
                        ...
                        COALESCE((FunctionalCI_functionalci_id_poly_PhysicalDevice.status = 'obsolete'),
                                 0)))))))))                                                                         AS functionalci_id_obsolescence_flag,
                IF
                ((
    ...
    lnkcontacttofunctionalci lnkContactToFunctionalCI
        ...
        LEFT JOIN (
            webapplication FunctionalCI_functionalci_id_poly_WebApplication
                ...
                FunctionalCI_functionalci_id_poly_WebApplication.webserver_id =
                WebServer_webserver_id_SoftwareInstance.id
                ))) ON ((
        ...
        LEFT JOIN (
            middlewareinstance FunctionalCI_functionalci_id_poly_MiddlewareInstance
                ...
                FunctionalCI_functionalci_id_poly_MiddlewareInstance.middleware_id =
