-- View Data Center Device
SELECT DISTINCT DatacenterDevice.id                                                                             AS id,
                ...
                COALESCE((Enclosure_enclosure_id_PhysicalDevice.status = 'obsolete'),
                         0)                                                                                     AS enclosure_id_obsolescence_flag,
                ...
                COALESCE((PowerConnection_powerA_id_PhysicalDevice.status = 'obsolete'),
                         0)                                                                                     AS powerA_id_obsolescence_flag,
                ...
                COALESCE((PowerConnection_powerB_id_PhysicalDevice.status = 'obsolete'),
                         0)                                                                                     AS powerB_id_obsolescence_flag
FROM ((((((
...
WHERE ((
    ...
    AND (
               0 <> COALESCE(
                   (PowerConnection_powerA_id_PhysicalDevice.finalclass IN ('PowerSource', 'PDU', 'PowerConnection')),
                   1))
    AND (
               0 <> COALESCE(
                   (PowerConnection_powerB_id_PhysicalDevice.finalclass IN ('PowerSource', 'PDU', 'PowerConnection')),
                   1)))